...
| File | Role |
| --- | --- |
| `manifests/deployment.yaml` | the `playground` application, 1 replica, port 8888 |
| `manifests/service.yaml` | ClusterIP service in front of it |
| `manifests/ingress.yaml` | exposes it on the cluster ingress |
